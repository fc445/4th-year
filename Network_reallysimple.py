...
keras.utils.plot_model(model, 'networkreallysimple_model.png', show_shapes=True)
...
model.save('networkreallysimple_model.h5')
model.save_weights('networkreallysimple_weights.h5')