...
def ResNet50(include_top=True,
    ...
    # Create model.
    model = Model(inputs, outputs=[output_cen_eas,output_cen_wes,output_bak_sou,output_bak_nor,output_vic_sou,output_vic_nor])
...
data = pd.concat([data[data.cen_eas==1], data[data.cen_wes==1],data[data.bak_sou==1],data[data.bak_nor==1],data[data.vic_sou==1],data[data.vic_nor==1]])
...
model = ResNet50(input_shape=(input_shape[0],input_shape[1],num_channels), classes=1)
model.summary()
